...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm._ssrNode("<div class=\"container\" style=\"overflow: hidden\">", "</div>", [_vm._ssrNode("<img id=\"cloud_img\"" + _vm._ssrAttr("src", __webpack_require__(164)) + " alt=\"cloud Image\"> "), _c('el-button', {
    attrs: {
      "id": "btn-hover",
      "type": "primary",
      "icon": "el-icon-edit",
  ...
  }), _vm._ssrNode(" <div id=\"parent-container\"><img id=\"mario_kart\"" + _vm._ssrAttr("src", __webpack_require__(165)) + " alt=\"cloud Image\"></div>")], 2)]);
};
var staticRenderFns = [];
